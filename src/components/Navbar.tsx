...
const Navbar = () => {
  return (
    ...
    <>
      <nav className="fixed top-0 left-0 w-full z-10 text-center p-2 text-black dark:text-blue-600 font-bold shadow-lg dark:shadow-3xl">
        <div className=" relative">
          <span className="hover:animate-pulse absolute left-10 top-1 text-3xl font-bold text-black dark:text-blue-600">
            Andreas<br />
            Höglund</span>
        </div>
